...
function init(){
    ...
    ref.child("Tenants").on("value", function(tenants){
        tenants.forEach(function(tenant){
            ...
            $('#tenantList > tbody:last-child').append('<tr><td>' + counter + '</td><td>' + attributes.val().Property + '</td><td>' + attributes.val().PrimaryName + '</td><td>' + attributes.val().SecondaryName + '</td><td><a href="#">View</a></td></tr>');
            });
        });
    });
}